...
export function CTASection() {
  ...
  return (
    <section className="w-full h-full flex justify-center items-center p-4 md:p-6">
      ...
      >
        <div className="relative overflow-hidden rounded-[48px] border border-border bg-card shadow-sm h-full w-full flex flex-col items-center justify-center duration-500 min-h-[500px]">
