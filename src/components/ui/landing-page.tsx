...
function ScrollGlobe({ sections, globeConfig = defaultGlobeConfig, className }: ScrollGlobeProps) {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (navLabelTimeoutRef.current !== null) {
...
// LegalAI Landing Page
export default function GlobeScrollDemo() {
  // Use dynamic import for navigation to avoid requiring react-router-dom at module level
  ...
  const legalSections = [
    {
      ...
      description: "AI-powered research, contract analysis, and draft generation — built for modern law firms who refuse to settle for outdated tools. Transform how you practice law.",
      align: "left" as const,
      actions: [
        { label: "Get Started", variant: "primary" as const, onClick: () => navigateTo("/register") },
        { label: "Sign In", variant: "secondary" as const, onClick: () => navigateTo("/login") },
      ]
    },
    {
      id: "research",
      badge: "Research",
      title: "Global Case Law Intelligence",
      description: "Query IPC sections, CrPC procedures, landmark Supreme Court judgments, and Bare Acts — all synthesized by AI in seconds. From precedent discovery to statutory interpretation, every answer is backed by real legal data.",
    ...
    },
    {
      ...
      badge: "Platform",
      title: "Your Complete",
      subtitle: "Legal Toolkit",
      description: "Every tool a modern law firm needs, unified in one powerful platform. No more switching between disconnected apps.",
      align: "left" as const,
      features: [
        { title: "AI Legal Research", description: "Search across IPC, CrPC, Bare Acts, and landmark judgments with natural language queries powered by RAG." },
        { title: "Contract Analyzer", description: "Upload contracts and get instant AI-driven clause analysis, risk assessment, and compliance checks." },
        { title: "Draft Generator", description: "Generate polished legal documents — petitions, notices, agreements — from structured prompts in seconds." },
        { title: "Case Calendar & Analytics", description: "Track hearings, deadlines, and litigation trends with intelligent scheduling and real-time insights." }
      ]
    },
    {
      id: "cta",
      ...
      subtitle: "Smarter Today.",
      description: "Join thousands of forward-thinking legal professionals who have already transformed their practice with law&tech. Your AI-powered legal command center is ready.",
      align: "center" as const,
      actions: [
        { label: "Create Free Account", variant: "primary" as const, onClick: () => navigateTo("/register") },
        { label: "Explore the Platform", variant: "secondary" as const, onClick: () => navigateTo("/login") }
      ]
    }
  ];
