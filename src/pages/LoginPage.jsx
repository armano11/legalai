      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-surface p-12 text-foreground border-r border-border">
        <div className="relative z-20">
          <Link to="/" className="flex items-center gap-2 text-lg font-bold tracking-tight">
            ...
            <span>law<span className="text-[#EC4E02]">&</span>tech</span>
          </Link>
        </div>
        ...
        <div className="relative z-20 flex items-center gap-8 text-sm text-slate-500 font-medium">
          <a href="#" className="hover:text-foreground transition-colors tracking-tight uppercase text-[10px]">Privacy</a>
          <a href="#" className="hover:text-foreground transition-colors tracking-tight uppercase text-[10px]">Terms</a>
          <a href="#" className="hover:text-foreground transition-colors tracking-tight uppercase text-[10px]">Contact</a>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                ...
                <a href="#" className="text-[10px] text-primary hover:underline font-black uppercase tracking-widest">Forgot?</a>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="remember" className="text-xs font-normal cursor-pointer text-muted-foreground">Remember session</Label>
              </div>
            </div>

            {error && (
              <div className="p-3 text-sm text-red-400 bg-red-500/10 border border-red-500/20 rounded-lg font-bold flex items-center gap-2">
